...
| LTE-M module | Internal M.2 card with an ESP32-S3 controller and a SIMCom SIM7080G modem (LTE-M / Cat-M1); pre-installed on production units together with a 1NCE nano-SIM and data plan. The UPS is fully functional without it — remote monitoring details in [Connectivity](https://docs.web3pi.io/ups/connectivity/index.md) |
