...
- **Remote firmware updates** — both the modem module and the UPS controller can be [updated over the air](https://docs.web3pi.io/ups/firmware-update/index.md) from the web panel.
...
| **Arkiv**            | Web3 Pi's Arkiv-compatible blockchain — [Arkiv mode](https://docs.web3pi.io/ups/connectivity/arkiv-mode/index.md) | Tamper-evident records for special/compliance needs     |
